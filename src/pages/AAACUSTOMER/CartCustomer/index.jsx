...
import { orderSelector, accountSelector } from '../../../redux/selectors';
            ...
            <div className="container w-full">
                ...
                <div className="mt-2 flex">
                    ...
                    <div className="flex flex-1 flex-col rounded-md border py-3 px-2 shadow">
                        ...
                        {/* LIST PRODUCT */}
                        <div className="flex h-[68vh] flex-col overflow-hidden">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-3 flex justify-between">
                                    ...
                                    <div className="flex justify-end">
                                        ...
                                        <button className="btn btn-green btn-md" onClick={() => createOrder()}>
                                            Đặt hàng
                                        </button>
                                    </div>
                                </div>
